...
var _swiperInitial = require("./modules/swiper/swiper-initial");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _swiperInitial.swiperTrainersTurnOn)();
  (0, _initAccordion.initAccordions)();
  (0, _swiperInitial.swiperOpinionsTurnOn)();
  (0, _initVideo.findVideos)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/swiper/swiper-initial":11,"./modules/tabs/init-tabs":12,"./modules/video/init-video":14,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
var Accordions = /*#__PURE__*/function () {
  ...
  _createClass(Accordions, [{
    ...
    value: function _documentClickHandler(evt) {
      ...
      var button = target.closest('[data-accordion="button"]');
...
exports.swiperOpinionsTurnOn = swiperOpinionsTurnOn;
exports.swiperTrainersTurnOn = swiperTrainersTurnOn;
var trainersSlider = document.querySelector('.trainers__slider');
var opinionSlider = document.querySelector('.opinions__slider');
function swiperTrainersTurnOn() {
  if (trainersSlider) {
    var swiper = new Swiper(trainersSlider, {
      initialSlide: 0,
      cssMode: true,
...
function swiperOpinionsTurnOn() {
  if (opinionSlider) {
    var swiper = new Swiper(opinionSlider, {
      slidesPerView: 1,
      cssMode: true,
      direction: 'horizontal',
      loop: false,
...
function setupVideo(video) {
  var link = video.querySelector('.about__video-link');
  var button = video.querySelector('.about__video-button');
  var id = video.dataset.src;
